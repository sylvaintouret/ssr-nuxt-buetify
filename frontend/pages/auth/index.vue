...
<div>
    <div>
        ...
        <button @click="signIn('credentials', { callbackUrl: '/auth', username: 'demo', password: 'password' })">
        sign in (credential)
        </button>
        <br>
        <button @click="signIn('github', { callbackUrl: '/auth' })">
        sign in (github)
        </button>
        <br>
        <button @click="signOut({ callbackUrl: '/auth/signout' })">
        sign out
        </button>
        <br>
    ...
    <div>
      ...
      <br>
      <nuxt-link to="/auth/examples/private">
        -> globally protected page
      </nuxt-link>
      <br>
      <nuxt-link to="/auth/examples/public">
...
const { data, status, lastRefreshedAt, getCsrfToken, getProviders, getSession, signIn, signOut } = useSession()
